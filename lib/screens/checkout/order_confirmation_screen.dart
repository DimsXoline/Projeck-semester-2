              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text('Siap dalam 20 menit', style: TextStyle(fontSize: 11, color: Colors.green, fontWeight: FontWeight.w500)),
                  ],
                ),
              ],
            ),
        ...
        children: [
          SizedBox(
            ...
            child: OutlinedButton(
              onPressed: () => _showOrderDetailDialog(context),
      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Divider(),
            _buildDetailRow('No. Pesanan', '#ROTI${DateTime.now().millisecondsSinceEpoch ~/ 1000}'),
            const SizedBox(height: 12),
            _buildDetailRow('Tanggal', '${DateTime.now().day}/${DateTime.now().month}/${DateTime.now().year}'),
            const SizedBox(height: 12),
            _buildDetailRow('Waktu', '${DateTime.now().hour.toString().padLeft(2, '0')}:${DateTime.now().minute.toString().padLeft(2, '0')}'),
            const SizedBox(height: 12),
            _buildDetailRow('Status', 'Diproses', status: true),
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(_formatPrice(totalAmount), style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: AppColors.primary)),
                ],
              ),
            ),
            const SizedBox(height: 20),
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            color: status ? Colors.orange : Colors.black87,
          ),
        ),
      ],
    );
